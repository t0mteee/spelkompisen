# Bakgrund och evidens till CLAUDE.md:s regler — fryst fulltext 2026-09-02

Detta är `CLAUDE.md` ordagrant som den såg ut före bantningen 2026-09-02
(1 274 rader, 92 kB). Reglerna lever vidare i `CLAUDE.md`; här finns varje
mätning, incident, siffra och datum som motiverade dem. Filen är historik och
uppdateras inte — ny evidens går i nya dokument under `docs/`.
